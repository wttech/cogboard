...
export const ADD_SETTINGS_ITEM = 'ADD_SETTINGS_ITEM';
export const EDIT_SETTINGS_ITEM = 'EDIT_SETTINGS_ITEM';
export const DELETE_SETTINGS_ITEM = 'DELETE_SETTINGS_ITEM';
export const WAITING_FOR_NEW_VERSION_DATA = 'WAITING_FOR_NEW_VERSION_DATA';
export const TOGGLE_LOGS_VIEWER_LOG = 'TOGGLE_LOGS_VIEWER_LOG';

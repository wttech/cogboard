...
class CogboardConstants {
    companion object {
        ...
        const val EVENT_CONTENT_UPDATE_WIDGET_CONFIG = "cogboard.config.widget.contentUpdate"
        ...
        const val EVENT_DELETE_CREDENTIALS = "cogboard.config.credentials.delete"
